...
/**
 * Setting 数据访问接口的 Oracle 实现。
 * <p>
 */
public class SettingDAOOracle implements SettingDAO {
    private static final Logger logger = LoggerFactory.getLogger(SettingDAOOracle.class);
    private QueryRunner run = null;

    public SettingDAOOracle() {
